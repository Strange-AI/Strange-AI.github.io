    ...
    created: function () {
        ...
        getRequest(aicodesUrl, params, function (data) {
            ...
            if (data.status == 'success') {
                ...
                vm.allAiCodesShow = vm.allAiCodes;
    ...
    methods: {
        ...
        filterFramework: function (i) {
            if (i == '全部') {
                ...
                vm.allAiCodesShow = vm.allAiCodes.filter(function (e) {
                    return vm.frameworkMap[e.code_framework] == i;
                });
            }
        ...
        filterCat: function (i) {
            if (i == '全部') {
                ...
                vm.allAiCodesShow = vm.allAiCodes.filter(function (e) {
                    return vm.catClass1[e.code_category_class_1] == i;
                });
            }
        },
